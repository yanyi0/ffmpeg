...
void AudioThread::run(){
   //文件名
   const char *inFilename = "/Users/cloud/Documents/iOS/音视频/TestMusic/Resample/44100_s16le_2.pcm";
   QFile inFile(inFilename);
   const char *outFilename = "/Users/cloud/Documents/iOS/音视频/TestMusic/Resample/48000_f32le_1_o.pcm";
   ...
   int outLinesize = 0;
   //声道数
   int outChs = av_get_channel_layout_nb_channels(AV_CH_LAYOUT_MONO);
   //每个输入样本的大小
